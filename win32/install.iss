...
Type: files; Name: "{app}\lib\site-packages\cola\*"
Type: files; Name: "{app}\lib\site-packages\cola\gui\*"
Type: files; Name: "{app}\lib\site-packages\cola\views\*"
Type: files; Name: "{app}\lib\site-packages\cola\controllers\*"
Type: dirifempty; Name: "{app}\lib\site-packages\cola\gui"
Type: dirifempty; Name: "{app}\lib\site-packages\cola\views"
Type: dirifempty; Name: "{app}\lib\site-packages\cola\controllers"
Type: dirifempty; Name: "{app}\lib\site-packages\cola"
