...
Type: files; Name: "{app}\share\git-cola\lib\qtpy\*"
Type: files; Name: "{app}\share\git-cola\lib\qtpy\_patch\*"
...
Type: dirifempty; Name: "{app}\share\git-cola\lib\qtpy\_patch"
Type: dirifempty; Name: "{app}\share\git-cola\lib\qtpy"
